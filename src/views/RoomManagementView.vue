    ...
    <div class="m-24">
        <div class="flex items-center justify-between mb-6">
            <div class="flex items-center gap-2">
                <h1 class="text-3xl font-semibold">Room Management</h1>
            </div>
        ...
        <v-alert v-else-if="!roomData?.data || roomData.data.length === 0" type="info" variant="tonal">
            Belum ada data room.
        </v-alert>
        ...
        <v-card v-else elevation="2px" rounded="xl" class="p-4">
            <v-table striped="even">
                ...
                <tbody>
                    <tr v-for="item in roomData.data" :key="item.id">
